...
public class EndForm extends javax.swing.JFrame {
     ...
     */
    public EndForm() throws RemoteException {
        initComponents();
    }
    ...
    private void initComponents() throws RemoteException {
        ...
        for(int i=0; i<ClientMain.store.getPlayers().size(); i++) {
        	Player p= ClientMain.store.getPlayers().get(i);
        	...
        	propertyList[i].setModel(new javax.swing.AbstractListModel<String>() {
                List<String> strings = new LinkedList<>(p.OwnedSquareName());
    ...
    private Player calculateWinner() throws RemoteException {
		int max = 0;
		Player winner = null;
